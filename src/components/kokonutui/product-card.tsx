    ...
    >
      <Card className="overflow-hidden h-full flex flex-col">
        ...
        <CardHeader className="p-0 relative">
          ...
          {discount && (
            <div className="absolute top-2 right-2 bg-destructive text-destructive-foreground text-xs font-medium px-2 py-1 rounded-md">
              -{discount}%
            </div>
          )}
        ...
        <CardContent className="p-4 flex-grow">
          ...
          <Link href={href} className="block">
            ...
            <h3 className="mt-1 text-base font-medium tracking-tight line-clamp-2 group-hover:text-primary transition-colors duration-200">
              {name}
            </h3>
          </Link>
